...
// source: kaiju/wasmx/v1/query.proto
...
func init() {
	proto.RegisterType((*QueryWasmxParamsRequest)(nil), "kaiju.wasmx.v1.QueryWasmxParamsRequest")
	proto.RegisterType((*QueryWasmxParamsResponse)(nil), "kaiju.wasmx.v1.QueryWasmxParamsResponse")
	proto.RegisterType((*QueryModuleStateRequest)(nil), "kaiju.wasmx.v1.QueryModuleStateRequest")
	proto.RegisterType((*QueryModuleStateResponse)(nil), "kaiju.wasmx.v1.QueryModuleStateResponse")
}

func init() { proto.RegisterFile("kaiju/wasmx/v1/query.proto", fileDescriptor_660c5209971a3cd4) }
...
func (c *queryClient) WasmxParams(ctx context.Context, in *QueryWasmxParamsRequest, opts ...grpc.CallOption) (*QueryWasmxParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/kaiju.wasmx.v1.Query/WasmxParams", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) WasmxModuleState(ctx context.Context, in *QueryModuleStateRequest, opts ...grpc.CallOption) (*QueryModuleStateResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/kaiju.wasmx.v1.Query/WasmxModuleState", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_WasmxParams_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/kaiju.wasmx.v1.Query/WasmxParams",
	}
...
func _Query_WasmxModuleState_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/kaiju.wasmx.v1.Query/WasmxModuleState",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "kaiju.wasmx.v1.Query",
	...
	Metadata: "kaiju/wasmx/v1/query.proto",
}
