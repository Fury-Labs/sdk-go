...
// source: kaiju/wasmx/v1/wasmx.proto
...
func init() {
	proto.RegisterType((*Params)(nil), "kaiju.wasmx.v1.Params")
}

func init() { proto.RegisterFile("kaiju/wasmx/v1/wasmx.proto", fileDescriptor_6818ff331f2cddc4) }
