...
// source: kaiju/types/v1beta1/tx_ext.proto
...
func init() {
	proto.RegisterType((*ExtensionOptionsWeb3Tx)(nil), "kaiju.types.v1beta1.ExtensionOptionsWeb3Tx")
}

func init() {
	proto.RegisterFile("kaiju/types/v1beta1/tx_ext.proto", fileDescriptor_b8dd2dd0020f764b)
}
