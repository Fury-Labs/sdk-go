...
// source: kaiju/types/v1beta1/account.proto
...
func init() {
	proto.RegisterType((*EthAccount)(nil), "kaiju.types.v1beta1.EthAccount")
}

func init() {
	proto.RegisterFile("kaiju/types/v1beta1/account.proto", fileDescriptor_e25f61138fdc8ede)
}
