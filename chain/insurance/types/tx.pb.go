...
// source: kaiju/insurance/v1beta1/tx.proto
...
type MsgCreateInsuranceFund struct {
	...
	// Oracle type
	OracleType types.OracleType `protobuf:"varint,6,opt,name=oracle_type,json=oracleType,proto3,enum=kaiju.oracle.v1beta1.OracleType" json:"oracle_type,omitempty"`
...
func init() {
	proto.RegisterType((*MsgCreateInsuranceFund)(nil), "kaiju.insurance.v1beta1.MsgCreateInsuranceFund")
	proto.RegisterType((*MsgCreateInsuranceFundResponse)(nil), "kaiju.insurance.v1beta1.MsgCreateInsuranceFundResponse")
	proto.RegisterType((*MsgUnderwrite)(nil), "kaiju.insurance.v1beta1.MsgUnderwrite")
	proto.RegisterType((*MsgUnderwriteResponse)(nil), "kaiju.insurance.v1beta1.MsgUnderwriteResponse")
	proto.RegisterType((*MsgRequestRedemption)(nil), "kaiju.insurance.v1beta1.MsgRequestRedemption")
	proto.RegisterType((*MsgRequestRedemptionResponse)(nil), "kaiju.insurance.v1beta1.MsgRequestRedemptionResponse")
}

func init() {
	proto.RegisterFile("kaiju/insurance/v1beta1/tx.proto", fileDescriptor_7e1fa941c3fd0dc4)
}
...
func (c *msgClient) CreateInsuranceFund(ctx context.Context, in *MsgCreateInsuranceFund, opts ...grpc.CallOption) (*MsgCreateInsuranceFundResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/kaiju.insurance.v1beta1.Msg/CreateInsuranceFund", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) Underwrite(ctx context.Context, in *MsgUnderwrite, opts ...grpc.CallOption) (*MsgUnderwriteResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/kaiju.insurance.v1beta1.Msg/Underwrite", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) RequestRedemption(ctx context.Context, in *MsgRequestRedemption, opts ...grpc.CallOption) (*MsgRequestRedemptionResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/kaiju.insurance.v1beta1.Msg/RequestRedemption", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_CreateInsuranceFund_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/kaiju.insurance.v1beta1.Msg/CreateInsuranceFund",
	}
...
func _Msg_Underwrite_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/kaiju.insurance.v1beta1.Msg/Underwrite",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_RequestRedemption_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/kaiju.insurance.v1beta1.Msg/RequestRedemption",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "kaiju.insurance.v1beta1.Msg",
	...
	Metadata: "kaiju/insurance/v1beta1/tx.proto",
}
