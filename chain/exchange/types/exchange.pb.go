...
// source: kaiju/exchange/v1beta1/exchange.proto

package types

import (
	fmt "fmt"
	types1 "github.com/Fury-Labs/sdk-go/chain/oracle/types"
...
type Params struct {
	// spot_market_instant_listing_fee defines the expedited fee in KAI required to create a spot market by bypassing governance
	...
	// derivative_market_instant_listing_fee defines the expedited fee in KAI required to create a derivative market by bypassing governance
	...
	// kai_reward_staked_requirement_threshold defines the threshold on KAI rewards after which one also needs staked KAI to receive more
	InjRewardStakedRequirementThreshold github_com_cosmos_cosmos_sdk_types.Int `protobuf:"bytes,15,opt,name=kai_reward_staked_requirement_threshold,json=kaiRewardStakedRequirementThreshold,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Int" json:"kai_reward_staked_requirement_threshold"`
	...
	// binary_options_market_instant_listing_fee defines the expedited fee in KAI required to create a derivative market by bypassing governance
	...
	AtomicMarketOrderAccessLevel AtomicMarketOrderAccessLevel `protobuf:"varint,19,opt,name=atomic_market_order_access_level,json=atomicMarketOrderAccessLevel,proto3,enum=kaiju.exchange.v1beta1.AtomicMarketOrderAccessLevel" json:"atomic_market_order_access_level,omitempty"`
...
// An object describing a derivative market in the Kaiju Futures Protocol.
type DerivativeMarket struct {
	...
	// Oracle type
	OracleType types1.OracleType `protobuf:"varint,4,opt,name=oracle_type,json=oracleType,proto3,enum=kaiju.oracle.v1beta1.OracleType" json:"oracle_type,omitempty"`
	...
	Status MarketStatus `protobuf:"varint,14,opt,name=status,proto3,enum=kaiju.exchange.v1beta1.MarketStatus" json:"status,omitempty"`
...
// An object describing a binary options market in Kaiju Protocol.
...
type SpotMarket struct {
	...
	MarketId string `protobuf:"bytes,7,opt,name=market_id,json=marketId,proto3" json:"market_id,omitempty"`
	// Status of the market
	Status MarketStatus `protobuf:"varint,8,opt,name=status,proto3,enum=kaiju.exchange.v1beta1.MarketStatus" json:"status,omitempty"`
...
type SpotOrder struct {
	...
	// order types
	OrderType OrderType `protobuf:"varint,3,opt,name=order_type,json=orderType,proto3,enum=kaiju.exchange.v1beta1.OrderType" json:"order_type,omitempty"`
...
type SpotLimitOrder struct {
	...
	// order types
	OrderType OrderType `protobuf:"varint,2,opt,name=order_type,json=orderType,proto3,enum=kaiju.exchange.v1beta1.OrderType" json:"order_type,omitempty"`
...
type SpotMarketOrder struct {
	...
	// order types
	OrderType OrderType `protobuf:"varint,4,opt,name=order_type,json=orderType,proto3,enum=kaiju.exchange.v1beta1.OrderType" json:"order_type,omitempty"`
	// trigger_price is the trigger price used by stop/take orders
...
func init() {
	proto.RegisterEnum("kaiju.exchange.v1beta1.AtomicMarketOrderAccessLevel", AtomicMarketOrderAccessLevel_name, AtomicMarketOrderAccessLevel_value)
	proto.RegisterEnum("kaiju.exchange.v1beta1.MarketStatus", MarketStatus_name, MarketStatus_value)
	proto.RegisterEnum("kaiju.exchange.v1beta1.OrderType", OrderType_name, OrderType_value)
	proto.RegisterEnum("kaiju.exchange.v1beta1.ExecutionType", ExecutionType_name, ExecutionType_value)
	proto.RegisterEnum("kaiju.exchange.v1beta1.OrderMask", OrderMask_name, OrderMask_value)
	proto.RegisterType((*Params)(nil), "kaiju.exchange.v1beta1.Params")
	proto.RegisterType((*MarketFeeMultiplier)(nil), "kaiju.exchange.v1beta1.MarketFeeMultiplier")
	proto.RegisterType((*DerivativeMarket)(nil), "kaiju.exchange.v1beta1.DerivativeMarket")
	proto.RegisterType((*BinaryOptionsMarket)(nil), "kaiju.exchange.v1beta1.BinaryOptionsMarket")
	proto.RegisterType((*ExpiryFuturesMarketInfo)(nil), "kaiju.exchange.v1beta1.ExpiryFuturesMarketInfo")
	proto.RegisterType((*PerpetualMarketInfo)(nil), "kaiju.exchange.v1beta1.PerpetualMarketInfo")
	proto.RegisterType((*PerpetualMarketFunding)(nil), "kaiju.exchange.v1beta1.PerpetualMarketFunding")
	proto.RegisterType((*DerivativeMarketSettlementInfo)(nil), "kaiju.exchange.v1beta1.DerivativeMarketSettlementInfo")
	proto.RegisterType((*NextFundingTimestamp)(nil), "kaiju.exchange.v1beta1.NextFundingTimestamp")
	proto.RegisterType((*SpotMarket)(nil), "kaiju.exchange.v1beta1.SpotMarket")
	proto.RegisterType((*Deposit)(nil), "kaiju.exchange.v1beta1.Deposit")
	proto.RegisterType((*SubaccountTradeNonce)(nil), "kaiju.exchange.v1beta1.SubaccountTradeNonce")
	proto.RegisterType((*OrderInfo)(nil), "kaiju.exchange.v1beta1.OrderInfo")
	proto.RegisterType((*SpotOrder)(nil), "kaiju.exchange.v1beta1.SpotOrder")
	proto.RegisterType((*SpotLimitOrder)(nil), "kaiju.exchange.v1beta1.SpotLimitOrder")
	proto.RegisterType((*SpotMarketOrder)(nil), "kaiju.exchange.v1beta1.SpotMarketOrder")
	proto.RegisterType((*DerivativeOrder)(nil), "kaiju.exchange.v1beta1.DerivativeOrder")
	proto.RegisterType((*SubaccountOrderbookMetadata)(nil), "kaiju.exchange.v1beta1.SubaccountOrderbookMetadata")
	proto.RegisterType((*SubaccountOrder)(nil), "kaiju.exchange.v1beta1.SubaccountOrder")
	proto.RegisterType((*SubaccountOrderData)(nil), "kaiju.exchange.v1beta1.SubaccountOrderData")
	proto.RegisterType((*DerivativeLimitOrder)(nil), "kaiju.exchange.v1beta1.DerivativeLimitOrder")
	proto.RegisterType((*DerivativeMarketOrder)(nil), "kaiju.exchange.v1beta1.DerivativeMarketOrder")
	proto.RegisterType((*Position)(nil), "kaiju.exchange.v1beta1.Position")
	proto.RegisterType((*MarketOrderIndicator)(nil), "kaiju.exchange.v1beta1.MarketOrderIndicator")
	proto.RegisterType((*TradeLog)(nil), "kaiju.exchange.v1beta1.TradeLog")
	proto.RegisterType((*PositionDelta)(nil), "kaiju.exchange.v1beta1.PositionDelta")
	proto.RegisterType((*DerivativeTradeLog)(nil), "kaiju.exchange.v1beta1.DerivativeTradeLog")
	proto.RegisterType((*SubaccountPosition)(nil), "kaiju.exchange.v1beta1.SubaccountPosition")
	proto.RegisterType((*SubaccountDeposit)(nil), "kaiju.exchange.v1beta1.SubaccountDeposit")
	proto.RegisterType((*DepositUpdate)(nil), "kaiju.exchange.v1beta1.DepositUpdate")
	proto.RegisterType((*PointsMultiplier)(nil), "kaiju.exchange.v1beta1.PointsMultiplier")
	proto.RegisterType((*TradingRewardCampaignBoostInfo)(nil), "kaiju.exchange.v1beta1.TradingRewardCampaignBoostInfo")
	proto.RegisterType((*CampaignRewardPool)(nil), "kaiju.exchange.v1beta1.CampaignRewardPool")
	proto.RegisterType((*TradingRewardCampaignInfo)(nil), "kaiju.exchange.v1beta1.TradingRewardCampaignInfo")
	proto.RegisterType((*FeeDiscountTierInfo)(nil), "kaiju.exchange.v1beta1.FeeDiscountTierInfo")
	proto.RegisterType((*FeeDiscountSchedule)(nil), "kaiju.exchange.v1beta1.FeeDiscountSchedule")
	proto.RegisterType((*FeeDiscountTierTTL)(nil), "kaiju.exchange.v1beta1.FeeDiscountTierTTL")
	proto.RegisterType((*AccountRewards)(nil), "kaiju.exchange.v1beta1.AccountRewards")
	proto.RegisterType((*TradeRecords)(nil), "kaiju.exchange.v1beta1.TradeRecords")
	proto.RegisterType((*SubaccountIDs)(nil), "kaiju.exchange.v1beta1.SubaccountIDs")
	proto.RegisterType((*TradeRecord)(nil), "kaiju.exchange.v1beta1.TradeRecord")
	proto.RegisterType((*Level)(nil), "kaiju.exchange.v1beta1.Level")
}

func init() {
	proto.RegisterFile("kaiju/exchange/v1beta1/exchange.proto", fileDescriptor_2116e2804e9c53f9)
}
