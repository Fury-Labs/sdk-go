...
// source: kaiju/tokenfactory/v1beta1/authorityMetadata.proto
...
type DenomAuthorityMetadata struct {
	// Can be empty for no admin, or a valid kaiju address
...
func init() {
	proto.RegisterType((*DenomAuthorityMetadata)(nil), "kaiju.tokenfactory.v1beta1.DenomAuthorityMetadata")
}

func init() {
	proto.RegisterFile("kaiju/tokenfactory/v1beta1/authorityMetadata.proto", fileDescriptor_525494b77b96b2d3)
}
