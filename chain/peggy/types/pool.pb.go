...
// source: kaiju/peggy/v1/pool.proto
...
func init() {
	proto.RegisterType((*IDSet)(nil), "kaiju.peggy.v1.IDSet")
	proto.RegisterType((*BatchFees)(nil), "kaiju.peggy.v1.BatchFees")
}

func init() { proto.RegisterFile("kaiju/peggy/v1/pool.proto", fileDescriptor_36397d69759ce164) }
