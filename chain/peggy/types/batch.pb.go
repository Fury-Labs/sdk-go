...
// source: kaiju/peggy/v1/batch.proto
...
func init() {
	proto.RegisterType((*OutgoingTxBatch)(nil), "kaiju.peggy.v1.OutgoingTxBatch")
	proto.RegisterType((*OutgoingTransferTx)(nil), "kaiju.peggy.v1.OutgoingTransferTx")
}

func init() { proto.RegisterFile("kaiju/peggy/v1/batch.proto", fileDescriptor_48fd09581f1b5901) }
