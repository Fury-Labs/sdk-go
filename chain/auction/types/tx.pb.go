...
// source: kaiju/auction/v1beta1/tx.proto
...
type MsgBid struct {
	...
	// amount of the bid in KAI tokens
...
func init() {
	proto.RegisterType((*MsgBid)(nil), "kaiju.auction.v1beta1.MsgBid")
	proto.RegisterType((*MsgBidResponse)(nil), "kaiju.auction.v1beta1.MsgBidResponse")
}

func init() {
	proto.RegisterFile("kaiju/auction/v1beta1/tx.proto", fileDescriptor_0943fd5f0d415547)
}
...
func (c *msgClient) Bid(ctx context.Context, in *MsgBid, opts ...grpc.CallOption) (*MsgBidResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/kaiju.auction.v1beta1.Msg/Bid", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_Bid_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/kaiju.auction.v1beta1.Msg/Bid",
	}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "kaiju.auction.v1beta1.Msg",
	...
	Metadata: "kaiju/auction/v1beta1/tx.proto",
}
