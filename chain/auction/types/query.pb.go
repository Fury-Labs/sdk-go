...
// source: kaiju/auction/v1beta1/query.proto
...
func init() {
	proto.RegisterType((*QueryAuctionParamsRequest)(nil), "kaiju.auction.v1beta1.QueryAuctionParamsRequest")
	proto.RegisterType((*QueryAuctionParamsResponse)(nil), "kaiju.auction.v1beta1.QueryAuctionParamsResponse")
	proto.RegisterType((*QueryCurrentAuctionBasketRequest)(nil), "kaiju.auction.v1beta1.QueryCurrentAuctionBasketRequest")
	proto.RegisterType((*QueryCurrentAuctionBasketResponse)(nil), "kaiju.auction.v1beta1.QueryCurrentAuctionBasketResponse")
	proto.RegisterType((*QueryModuleStateRequest)(nil), "kaiju.auction.v1beta1.QueryModuleStateRequest")
	proto.RegisterType((*QueryModuleStateResponse)(nil), "kaiju.auction.v1beta1.QueryModuleStateResponse")
}

func init() {
	proto.RegisterFile("kaiju/auction/v1beta1/query.proto", fileDescriptor_2ae80edbdb9fffb7)
}
...
func (c *queryClient) AuctionParams(ctx context.Context, in *QueryAuctionParamsRequest, opts ...grpc.CallOption) (*QueryAuctionParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/kaiju.auction.v1beta1.Query/AuctionParams", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) CurrentAuctionBasket(ctx context.Context, in *QueryCurrentAuctionBasketRequest, opts ...grpc.CallOption) (*QueryCurrentAuctionBasketResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/kaiju.auction.v1beta1.Query/CurrentAuctionBasket", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) AuctionModuleState(ctx context.Context, in *QueryModuleStateRequest, opts ...grpc.CallOption) (*QueryModuleStateResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/kaiju.auction.v1beta1.Query/AuctionModuleState", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_AuctionParams_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/kaiju.auction.v1beta1.Query/AuctionParams",
	}
...
func _Query_CurrentAuctionBasket_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/kaiju.auction.v1beta1.Query/CurrentAuctionBasket",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_AuctionModuleState_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/kaiju.auction.v1beta1.Query/AuctionModuleState",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "kaiju.auction.v1beta1.Query",
	...
	Metadata: "kaiju/auction/v1beta1/query.proto",
}
